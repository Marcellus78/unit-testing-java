...
public class OrderTest {
    ...
    void mealsShouldBeInCorrectOrderAfterAddingThemToOrder(){
        ...
        //then
        assertThat(order.getMeals(), contains(meal,meal2));//kolejność dodawania ma znaczenie
        assertThat(order.getMeals(),containsInAnyOrder(meal2, meal)); //kolejność nie ma znaczenia
    }
