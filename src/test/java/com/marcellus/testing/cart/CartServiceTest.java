...
import com.marcellus.testing.order.OrderStatus;
...
class CartServiceTest {
    ...
    @Test
    void processCarShouldSendToPrepare() {
    ...
    @Test
    void processCarShouldNotSendToPrepare() {
    ...
    @Test
    void processCarShouldNotSendToPrepareWithArgumetnMatchers() {
    ...
    @Test
    void processCarShouldSendToPrepareWithLamdas() {
    ...
    @Test
    void processCarShouldSendToPrepareWithArgumentCaptors() {
