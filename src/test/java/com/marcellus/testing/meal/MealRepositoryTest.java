...
import com.marcellus.testing.meal.MealRepository;
...
public class MealRepositoryTest {
    ...
    @Test
    void shouldBeAbleToAddToRepository(){
    ...
    @Test
    void shouldBeAbleToFindByExactNameMeal(){
        //given
        Meal meal = new Meal(10, "Pizza");
    ...
    @Test
    void shouldBeAbleToFindByNameByStartingLetters(){
        //given
        Meal meal = new Meal(10, "Pizza");
        Meal meal2 = new Meal(10,"Pi");
        mealRepository.add(meal);
